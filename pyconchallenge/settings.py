"""
Django settings for pyconchallenge project.
...
SECRET_KEY = '7(o8_r)c*h1f(vh0k%8mbpx=a7s=hgpi52ay@fxzk!f7&%zoxr'
...
ROOT_URLCONF = 'pyconchallenge.urls'
...
WSGI_APPLICATION = 'pyconchallenge.wsgi.application'
